...
class FfmpegHelper{
  ...
  Future<MediaInformation?>getMediaInfo({String? inputPath,
    int? waitTimeout=99999 })async {
  ...
  //视频开始和结束时间
  setVideoSliceTime({required Duration startPoint,required Duration endPoint}){
